...
export default function NewArticle() {
  ...
  const [editorMode, setEditorMode] = useState('simple'); // simple | rich
  ...
  const generateSlug = (title) =>
    title.toLowerCase().replace(/[^a-z0-9\s-]/g, '').replace(/\s+/g, '-').replace(/-+/g, '-').trim() + '-' + Date.now();
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111', margin: 0 }}>📰 New Article</h1>
          <p style={{ fontSize: 13, color: '#888', marginTop: 4 }}>Create a new news article</p>
        </div>
          ...
          {editorMode === 'rich' && (
            <div>
              ...
              <div style={{
                ...
                borderRadius: '10px 10px 0 0', border: '2px solid #e8e8e8', borderBottom: 'none',
                flexWrap: 'wrap',
              }}>
                {[
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button onClick={() => handleSubmit('published')} disabled={saving} style={{
                ...
                border: 'none', background: '#D42A2A', color: '#fff',
                cursor: 'pointer', fontFamily: 'inherit',
          ...
          <div style={{
            ...
            {imagePreview || form.image_url ? (
              <div style={{ marginBottom: 12 }}>
                <img src={imagePreview || form.image_url} alt="Preview" style={{
                  width: '100%', borderRadius: 10, objectFit: 'cover', aspectRatio: '16/10',
                }} />
                <button onClick={() => { setImagePreview(null); handleChange('image_url', ''); }} style={{
                  marginTop: 8, fontSize: 12, color: '#D42A2A', background: 'none',
            ...
            <label style={{
              ...
              padding: 24, border: '2px dashed #e0e0e0', borderRadius: 10,
            ...
            <input
              ...
              placeholder="https://..."
              style={{ ...inputStyle, fontSize: 12, padding: '8px 12px', marginTop: 6 }}
            />
          </div>
          ...
          <div style={{
            ...
            <label style={{
              display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', fontSize: 13, color: '#555',
            }}>
              <input
                type="checkbox"
            ...
            <p style={{ fontSize: 11, color: '#aaa', marginTop: 6, marginLeft: 28 }}>
              Featured articles appear in the hero section on homepage
            </p>
          </div>
        </div>
      </div>
